...
class Scary_Halloween_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'scary-halloween' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $scary_halloween_font_awesome_icon_array = scary_halloween_font_awesome_icon_array();
                    foreach ($scary_halloween_font_awesome_icon_array as $scary_halloween_font_awesome_icon) {
                            $icon_class = $this->value() == $scary_halloween_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($scary_halloween_font_awesome_icon).'"></i>
                            <span class="scary-halloween-social-class">'.esc_attr($scary_halloween_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function scary_halloween_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'scary-halloween-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'scary_halloween_customizer_script' );

if(!function_exists('scary_halloween_font_awesome_icon_array')){
    function scary_halloween_font_awesome_icon_array(){
